/* ============================================================
   אהבת חינ"מ - אנימציית כניסה ללוגו (בית הפאזל)
   ------------------------------------------------------------
   מחליף את אייקון הלוגו בהאדר (אלמנט עם class="brand-mark__icon")
   בארבעת חלקי הפאזל בנפרד, ומריץ אנימציית כניסה בכל טעינת עמוד
   (כולל רענון) - אבל בלי לולאה: כל חלק מתאנימציה פעם אחת ונעצר
   במקומו הסופי (fill-mode:both, אין animation-iteration-count).
   אם prefers-reduced-motion פעיל, האייקון מוצג ישר במקומו הסופי.
...
(function () {
  ...
  PIECES.forEach(function (p) {
    ...
    img.src = '/images/logo-pieces/' + p.src;
    img.alt = '';

...
export const Route = createFileRoute("/event-hanukkah")({ component: EventHanukkah });

function EventHanukkah() {
  return (
    <Layout theme="blue" title={"פעילויות חנוכה עם בתי הספר - אהבת חינ\"מ"} description={"בכל אחד משמונת ימי החנוכה התארחו בבית שי להדלקת נר חגיגית עשרות אורחים מבתי הספר בנהריה."}>
      <section className="page-hero page-hero--slim">
            <div className="container container--narrow">
              <nav className="crumbs" aria-label="מיקום בעמוד">
                ...
                <span aria-hidden="true">›</span>
                <span aria-current="page">פעילויות חנוכה עם בתי הספר</span>
              </nav>
              <span className="eyebrow" data-reveal="fade">חנוכה</span>
              <h1 data-reveal="up">פעילויות חנוכה עם בתי הספר</h1>
              <p className="page-hero__lead" data-reveal="up" style={{ '--d': '200ms' }}>בכל אחד משמונת ימי החנוכה התארחו בבית שי להדלקת נר חגיגית עשרות אורחים מבתי הספר בנהריה.</p>
            </div>
          </section>

          <section className="sec sec--tight container container--narrow">
            <figure className="event-figure" data-reveal="up">
              <img src="/images/content/d08.jpg" alt="ילד אוחז בדגל ישראל באירוע ערב בנהריה" loading="lazy" />
